...
function registration() {
  ...
  useEffect(() => {
    ...
    setDisabled(registrationValidation());
  }, [newName, newEmail, newPassword, confirmPassword]);
  ...
  const handleSubmit = async (e) => {
    ...
    const newUser = { fullName: newName, email: newEmail, password: newPassword };
    const newStoredUser = await createUser(newUser);
    setNewUser(newStoredUser);
