...
describe('POST /comments/ endpoint tests', () => {
  ...
  const clearDatabase = async () => {
    try {
      ...
      const result2 = await db.collection('posts').update({"_id" : ObjectId("6376e52e15dd8a7a841cd930")},{$pull: {'comments' : '638bdd0b34095ec1d5b4e6a8'}})
