...
const { ThreeDRotation } = require('@mui/icons-material');
...
describe('POST /comments/ endpoint tests', () => {
  ...
  let login;
  const testComment = {
    content: "This is a jest testing comment on 122122 6:12pm",
    userId: "638bebd66d818a6c63d82345",
  };
  /**
  ...
  beforeAll(async () => {
    ...
    // get the db
    db = mongo.db();
    login = await request(webapp).post('/login').send('email=demo123@gmail.com');
    ...
    // setTimeout(async ()=>{    
      ...
      //   .send('content=This is a jest testing comment on 122122 6:12pm&userId=638bebd66d818a6c63d82345');
      // // eslint-disable-next-line no-underscore-dangle
      // // console.log('The testCommentId response in comment.test.js is: ');
  ...
  const clearDatabase = async () => {
    try {
      ...
      const result2 = await db.collection('posts').updateOne({"_id" : ObjectId("6376e52e15dd8a7a841cd930")},{$pull: {'comments' : '638bdd0b34095ec1d5b4e6a8'}})
