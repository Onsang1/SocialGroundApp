 ...
 */
  test('the new holdAccount is returned', () => {
    ...
    expect(JSON.parse(response.text).data).toMatchObject(insertedholdAccount); // status code
  });
  ...
  test('Get all hold endpoint status code and data', async () => {
    ...
    expect(holdAccountArr)
      .toEqual([{ _id: '507f191e810c19729de860ea', time: 1519211811670 },
        { _id: '6348acd2e1a47ca32e79f46f', time: 1519211811670 }]);
  });
  // bad
